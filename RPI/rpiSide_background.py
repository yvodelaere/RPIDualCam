...
with picamera.PiCamera(sensor_mode=2, resolution=videoRes, framerate=24) as camera:
    isoCamera = 100
    camera.iso = isoCamera
    # Wait for the automatic gain control to settle
    time.sleep(2)
    # Now fix the values
    exSpeed = camera.exposure_speed
    camera.shutter_speed = exSpeed
    ...
    with open('gainSettings.pickle', 'wb') as f:
        pickle.dump([isoCamera, exSpeed, awbGains], f)
